...
class Graph:
    ...
    def connections_from(self, node):
        ...
        return [(self.nodex[col_num], self.adj_mat[node][col_num])
    ...
    def con_traverse_dir(self, node1, node2):
        node1, node2 = (self.get_index_from_node(node1),
                        self.get_index_from_node(node2))
        return self.adj_mat[node1][node2] != 0

    def has_conn(self, node1, node2):
        return (self.can_traverse_dir(node1, node2) or
                self.can_traverse_dir(node2, node1))
